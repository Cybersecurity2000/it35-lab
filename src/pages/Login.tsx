...
const Login: React.FC = () => {
  ...
  // ✅ Background GIF — change here only
  const bgGifUrl = 'https://i.pinimg.com/originals/3d/e0/b1/3de0b1c2cd036a5112ac231af2c5b7c6.gif';
    ...
    <IonPage>
      <IonContent className="ion-padding" fullscreen>
        <div style={{
          ...
          alignItems: 'center',
          height: '100%',
          backgroundImage: `url(${bgGifUrl})`, // ✅ Dynamic background
